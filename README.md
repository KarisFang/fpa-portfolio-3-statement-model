...
**Portfolio project #1 of 3** ([Project 2: automated reporting
pipeline](https://github.com/KarisFang/fpa-portfolio-reporting-pipeline) · [Project 3: budget-vs-actual variance dashboard](https://github.com/KarisFang/fpa-portfolio-variance-dashboard))
